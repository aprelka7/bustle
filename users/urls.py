...
urlpatterns = [
    ...
    path('profile/allergens/', views.allergen_preferences, name='allergen_preferences'),
    path('profile/allergens/update/', views.update_allergen_preferences, name='update_allergen_preferences'),
